...
describe("BanModule", () => {
    ...
    before(async () => {
        ...
        const BanModuleContract = await ethers.getContractFactory("BanModuleUpgradable");
        banModuleAdmin = await upgrades.deployProxy(BanModuleContract, [dataUnionAdmin.address]) as BanModule
