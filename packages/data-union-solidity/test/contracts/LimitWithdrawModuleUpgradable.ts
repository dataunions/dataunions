...
describe("LimitWithdrawModuleUpgradable", () => {
    ...
    let limitWithdrawModule: LimitWithdrawModuleUpgradable
    ...
    before(async () => {
        ...
        const LimitWithdrawContract = await ethers.getContractFactory("LimitWithdrawModuleUpgradable");
        limitWithdrawModule = await upgrades.deployProxy(LimitWithdrawContract, limitWithdrawModuleArgs, {initializer:'init'}) as LimitWithdrawModuleUpgradable
