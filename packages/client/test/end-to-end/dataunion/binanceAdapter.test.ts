...
// const log = debug('DataUnionClient::DataUnion::binanceAdapter')
...
describe('Binance Adapter functions', () => {
    ...
    //     const client2 = new DataUnionClient(config2.clientOptions as any)
    //     const client2address = await client2.getAddress()
    //     const adminClient = new DataUnionClient(config.clientOptions as any)
